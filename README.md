...
要让你的 AI 助手（如 Antigravity, OpenCode Agent）使用这组 Skill，请按照以下步骤操作：
...
2. **配置工作区**：
   在你的 AI 助手的设置或配置文件（如 `.gemini/config.json`）中，将该目录添加到 `skills` 路径中。
...
- **视频总结**："总结一下这个 YouTube 视频的核心观点：[URL]。"
